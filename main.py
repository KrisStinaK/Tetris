...
bg = pygame.image.load('c62a61ad6b32276c40df9f73bbb1faee.jpg').convert()
game_bg = pygame.image.load('koshka-ushi-vzglyad-ogni.jpg').convert()

main_font = pygame.font.Font(None, 65)
font = pygame.font.Font(None, 60)

title_tetris = main_font.render('TETRIS', True, pygame.Color('darkgreen'))
